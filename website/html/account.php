...
if (isset($_GET['reloaded'])) {
    if ($_GET['reloaded'] == 'userNameChanged') {
        ...
        echo "Email";
    }elseif($_GET['reloaded'] == 'usePasswordChanged'){
        echo "Password";
    }
}
?>
    ...
    <body>
        ...
        <div class="popup-screen" id="email-container">
            <div class="popup-form">
                ...
                <div class="change-form">
                    <form method="POST" action="account.php?reloaded=userEmailChanged" id="usernameForm">
        ...
        <div class="popup-screen" id="password-container">
            <div class="popup-form">
                ...
                <div class="change-form">
                    <form method="POST" action="account.php?reloaded=userPasswordChanged" id="usernameForm">
